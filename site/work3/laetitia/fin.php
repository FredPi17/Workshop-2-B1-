...
if ($_GET['fin'] == "competitivite") {
	echo'
	<style> body{background-image: url(images/'. $_SESSION['profil'][0]['image'] .');background-repeat: no-repeat;background-size: 100% auto;}
	</style>
	<div id="contenu">
	<div id="title">
...
if ($_GET['fin'] == "social") {
	echo'
	<style> body{background-image: url(images/'. $_SESSION['profil'][1]['image'] .');background-repeat: no-repeat;background-size: 100% auto;}
	</style>
	<div id="contenu">
	<div id="title">
...
if ($_GET['fin'] == "environnement") {
	echo'
	<style> body{background-image: url(images/'. $_SESSION['profil'][2]['image'] .');background-repeat: no-repeat;background-size: 100% auto;}
	</style>
	<div id="contenu">
	<div id="title">
...
if ($_GET['fin'] == "gg") {
	echo'
	<style> body{background-image: url(images/'. $_SESSION['profil'][4]['image'] .');background-repeat: no-repeat;background-size: 100% auto;}
	</style>
	<div id="contenu">
	<div id="title">
		<h1>'. $_SESSION['profil'][4]['intitule'] .'</br> '. $_SESSION['profil'][0]['Desciption'] .'</h1>
	</div>
